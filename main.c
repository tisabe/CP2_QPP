...
int main(){
    ...
    if(integrator == 1){
        double complex *euler_out = malloc(params.L*sizeof(double complex));
        euler_method(euler_out, start_wf, params);
